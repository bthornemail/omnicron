...
SRC_FILE="${1:-$ROOT_DIR/logic/sources/omnicron-rule-source.org}"
POLYLOG_BIN="${2:-$ROOT_DIR/polylog}"
EXTRACTED_FILE="${3:-$ROOT_DIR/logic/generated/omnicron-rule-source.extracted.logic}"
RUN_LOG="${4:-$ROOT_DIR/logic/generated/omnicron-rule-source.run.log}"
