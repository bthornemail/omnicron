...
function main() {
  ...
  const outNdjson = path.join(repoRoot, "prolog/ontology_graph.ndjson");
  const outDot = path.join(repoRoot, "prolog/ontology_graph.dot");
  const outLegend = path.join(repoRoot, "prolog/ontology_legend.ndjson");
  ...
  addNode(fileUniversal, "The Universal Logic Page.md", "file", "authoritative", "The Universal Logic Page.md", "");
  addNode(fileDecl, "omnitron_declarations.lx", "file", "authoritative", "prolog/omnitron_declarations.lx", "");
  addNode(fileRules, "rules_selected.logic", "file", "authoritative", "polyform/bitboards/rules_selected.logic", "");
  addNode(fileOntology, "ONTOLOGY.md", "file", "derived", "prolog/ONTOLOGY.md", "");
  addNode(filePair, "pair-machine.c", "file", "authoritative", "pair-machine.c", "");
  addNode(lexApi, "omnitron_ddc_lexicon.h", "lexicon", "declared_partial", "prolog/omnitron_ddc_lexicon.h", "");
  addNode(lexRuntime, "lexicon runtime implementation", "lexicon", "not_integrated", "", "");

  addEdge(fileUniversal, fileDecl, "declares", "The Universal Logic Page.md", "");
  addEdge(fileDecl, fileRules, "emits", "prolog/omnitron_declarations.lx", "");
  addEdge(fileRules, fileOntology, "projects_to", "polyform/bitboards/rules_selected.logic", "");
  addEdge(fileDecl, lexApi, "declares", "prolog/omnitron_declarations.lx", "");
  addEdge(lexApi, lexRuntime, "declares", "prolog/omnitron_ddc_lexicon.h", "runtime implementation missing");
  ...
  addNode(artGraph, "ontology_graph.ndjson", "artifact", "derived", "prolog/ontology_graph.ndjson", "");
  addNode(artPgm, "ontology_graph.pgm", "artifact", "derived", "prolog/ontology_graph.pgm", "");
  addNode(artDot, "ontology_graph.dot", "artifact", "derived", "prolog/ontology_graph.dot", "");
  ...
  addEdge(artGraph, artPgm, "projects_to", "prolog/ontology_graph_to_pgm.mjs", "ndjson -> pgm");
  addEdge(artGraph, artDot, "projects_to", "prolog/generate_ontology_graph.mjs", "ndjson -> dot");
