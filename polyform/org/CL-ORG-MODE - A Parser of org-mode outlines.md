...
4.7 Utilities
5 ORG-LITERATE-PROGRAMMING Source Code
6 ORG-LISP-DOCUMENTATION
...
2 Finding and Installing
This document, or possibly the document used to generate this document, is a complete copy of the cl-org-mode source… it just needs extracting, which requires cl-org-mode or some manual labour. If the former idea is more to your liking, get it using git : =git clone http://common-lisp.net/project/cl-org-mode/cl-org-mode.git=
