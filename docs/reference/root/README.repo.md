...
```
docs/reference/root/ASCII_CONSTITUTIONAL_MACHINE.md  # Portable ASCII/C/Datalog/Scheme machine model
docs/reference/root/CONSTITUTION.md                  # Numerical constitution reference
...
- `docs/reference/root/ASCII_CONSTITUTIONAL_MACHINE.md`: defines the portable constitutional stack as ASCII bytes -> kernel replay -> relational closure -> Scheme transformation -> human surfaces
- `docs/reference/root/CONSTITUTION.md`: maps constitutional numbers and non-equivalence laws to the implementation
- `docs/reference/riscv/ATOMIC_KERNEL_SPEC.md`: defines the six kernel laws and structural control-plane roles
...
## WordNet Synset Graph (Prolog)

Build and verify the WordNet-style synset graph pipeline:
...
- Input Prolog facts: `logic/sources/wordnet_synset_test.pl`
- Graph builder: `logic/tools/wordnet_prolog_to_synset_graph.mjs`
- Output artifact: `logic/generated/wordnet_synset_graph.ndjson`

The generated NDJSON object is expected to contain:

- `type: "wordnet_synset_graph"`
- `nodes` for each synset (`id`, `synset_id`, `pos`, `canonical_lemma`, `lemmas`)
- `edges` with `relation: "hypernym"`
