...
- `docs/reference/root/CONSTITUTION.md`
- `docs/reference/root/ASCII_CONSTITUTIONAL_MACHINE.md`
- `docs/reference/root/README.repo.md`
...
- `docs/reference/riscv/README.riscv.md`
- `docs/reference/riscv/ATOMIC_KERNEL_SPEC.md`

Policy:

- `docs/` is canonical.
- `dev-docs/` is mutable research workspace.
